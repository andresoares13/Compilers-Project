...
public class MyGraphColoring {
    ...
    public MyGraphColoring(ArrayList<HashMap<Node, ArrayList<Operand>>> liveRanges, Method m, List<Report> reports) {
    ...
    public HashMap<String, Descriptor> graphColoring(int nRegisters) {
        ...
        while (!stack.isEmpty()) {
            ...
            if (!canBeColored) {
                ...
                return graphColoring(numberOfRegisters + 1);
            }
        }
